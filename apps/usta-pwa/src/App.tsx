...
function AdminPortal() {
  ...
  return <><AdminRouter /><div className="admin-shortcuts"><a href="/admin/coupons">Kupon Takibi</a><a href="/admin/notifications">Bildirim Gönder</a><a href="/admin/dealer-employees">Bayi Çalışanları</a><a href="/admin/adjustments">± Puan Düzelt</a></div><button className="admin-logout" onClick={exit} type="button">{profile.user} · Çıkış</button></>
}
