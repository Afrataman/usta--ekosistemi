...
function AdminPortal() {
  ...
  return <><AdminRouter /><a className="admin-adjustment-shortcut" href="/admin/adjustments">± Puan Düzelt</a><button className="admin-logout" onClick={exit} type="button">{profile.user} · Çıkış</button></>
}
