...
import { createSupportRequest, fulfillDealerCoupon, getCampaigns, getCraftsmanDashboard, getCraftsmanProfile, getRewardRedemptions, getRewards, getSupportRequests, getWallet, redeemProductCode, redeemReward, reportDealerRisk, requestOtpCode, returnDealerProduct, updateCraftsmanProfile, verifyDealerCoupon, verifyOtpCode, type Campaign, type CraftsmanProfile, type Dashboard, type DealerCoupon, type ProductReturnResult, type Reward, type RewardRedemption, type RewardRedemptionResult, type SupportItem, type Wallet as WalletData } from './api'
import './App.css'
...
function App() { return window.location.pathname.startsWith('/dealer/risk') ? <DealerRiskPage /> : window.location.pathname.startsWith('/dealer') ? <DealerApp /> : <CraftsmanApp /> }
